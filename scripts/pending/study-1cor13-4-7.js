,
{
  ...
  sections:[
    ...
    {n:"4",id:"neuro",title:"The Neuroplasticity Bridge",blocks:[
      {type:"p",html:'God made minds that take the shape of what they keep doing. This church already had practices: jealousy and strife (3:3), puffing up (4:6; 8:1), seeking their own (chs. 8&ndash;10). Those are not moods that blow through. They are repeated moves. A creature who keeps scoring, logging the wrong, and defending his own way becomes more ready to do the next score, the next log, the next defense. Paul does not need a later map of the nervous system to say that. He is talking about the people in front of him.'},
      {type:"p",html:'That is why the verbs stay present tense. Love <em>is</em> patient. Love <em>is</em> kind. Love <em>does not</em> keep the account. In a body, love is a way of going on &mdash; a manner that can be rehearsed, and a manner that can be refused. A later science has a name for paths cut by repetition. The name rhymes with this paragraph because both describe the same creature. The rhyme is not the meaning of the text. The paragraph is true because this is how God made people.'},
      {type:"p",html:'The agent is not the reader administering a kindness drill. The Spirit produces patience and kindness as fruit (Galatians 5:22) &mdash; the same two first verbs of v.4. Paul tells you what love does. He does not hand you a technique for growing a new mind. If the neuroscience sentence is deleted, the exegesis still stands: love remains, and it will not keep the ledger. That is the right size of the rhyme.'},
      {type:"callout",style:"oneline",label:"In one line",html:"love is a practiced way of remaining — and the Spirit, not a drill, grows what God made the mind able to hold."}
    ]},
